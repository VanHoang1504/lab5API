package com.example.Lab5_PH42448;
...
import com.example.Lab5_PH42448.adapter.DistributorAdapter;
import com.example.Lab5_PH42448.databinding.ActivityMainBinding;
import com.example.Lab5_PH42448.databinding.DialogAddBinding;
import com.example.Lab5_PH42448.model.Distributor;
import com.example.Lab5_PH42448.model.Response;
import com.example.Lab5_PH42448.services.HttpRequest;
        ...
        binding.edSearch.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    ...
                    String keyWithoutDiacritics = removeDiacritics(key);
                    httpRequest.callAPI()
                            .searchDistributor(keyWithoutDiacritics)
                            .enqueue(getDistributorAPI);
                    Log.d(TAG, "onEditorAction: " + keyWithoutDiacritics);
                    return true;
                }
                return false;
            }
